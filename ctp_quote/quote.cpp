...
DLL_EXPORT_C_DECL void* WINAPI GetTradingDay(CThostFtdcMdApi *api ){api->GetTradingDay(); return 0;}
...
DLL_EXPORT_C_DECL void* WINAPI ReqUserLogin(CThostFtdcMdApi *api ,CThostFtdcReqUserLoginField *pReqUserLogin, int nRequestID){api->ReqUserLogin(pReqUserLogin,nRequestID); return 0;}

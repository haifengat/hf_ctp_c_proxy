...
DLL_EXPORT_C_DECL void* WINAPI GetTradingDay(CThostFtdcTraderApi *api ){api->GetTradingDay(); return 0;}
...
DLL_EXPORT_C_DECL void* WINAPI ReqAuthenticate(CThostFtdcTraderApi *api ,CThostFtdcReqAuthenticateField *pReqAuthenticate, int nRequestID){api->ReqAuthenticate(pReqAuthenticate,nRequestID); return 0;}
DLL_EXPORT_C_DECL void* WINAPI ReqUserLogin(CThostFtdcTraderApi *api ,CThostFtdcReqUserLoginField *pReqUserLogin, int nRequestID){api->ReqUserLogin(pReqUserLogin,nRequestID); return 0;}
